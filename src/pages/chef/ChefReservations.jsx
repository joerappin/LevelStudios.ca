...
export default function ChefReservations() {
  ...
  return (
    <Layout navItems={CHEF_NAV} title="Réservations">
      ...
      {showCreate && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4" onClick={closeCreate}>
          <div className={`border rounded-2xl w-full max-w-5xl max-h-[90vh] overflow-y-auto ${modalBg}`} onClick={e => e.stopPropagation()}>
