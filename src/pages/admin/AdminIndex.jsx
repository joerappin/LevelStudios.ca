            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px' }}>
              ...
              {group.badge && (
                <span style={{ fontSize: '10px', fontWeight: 700, padding: '2px 8px', borderRadius: '999px', background: `${group.color}18`, border: `1px solid ${group.color}40`, color: group.color, letterSpacing: '0.05em' }}>
                  {group.badge === 'Chef' ? <span style={{ display: 'flex', alignItems: 'center', gap: '4px' }}><Crown size={9} /> Chef de projets</span> : <span style={{ display: 'flex', alignItems: 'center', gap: '4px' }}><UserCheck size={9} /> Employé</span>}
                </span>
              )}
            </div>
              ...
              {group.pages.map(page => {
                ...
                return (
                  <button key={page.key}
                    ...
                    style={{ background: '#111', border: '1px solid #1e1e1e', borderRadius: '14px', padding: '20px 16px', cursor: 'pointer', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '12px', textAlign: 'left', transition: 'all 0.18s', position: 'relative', overflow: 'hidden' }}
                  ...
                  >
                    ...
                    <div>
                      <p style={{ fontSize: '13px', fontWeight: 600, color: '#ddd', marginBottom: '3px' }}>{page.label}</p>
